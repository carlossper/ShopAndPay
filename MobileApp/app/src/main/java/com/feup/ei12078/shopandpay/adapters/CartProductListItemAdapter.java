...
public class CartProductListItemAdapter extends BaseAdapter {
    ...
    public CartProductListItemAdapter(List<Product> products, Activity act, TextView totalPriceView) {
